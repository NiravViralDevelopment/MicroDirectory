    ...
    <section class="section frmGrp">
      <div class="row">
        <div class="col-lg-12">
              ...
              <!-- Horizontal Form -->
              <form action="{{ route('countries-update',$data->id) }}" method="POST" enctype="multipart/form-data"> @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5 d-flex align-items-center">
                        ...
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ $data->is_active == 1 ? 'checked' : '' }}>
                    </div>
                </div>
