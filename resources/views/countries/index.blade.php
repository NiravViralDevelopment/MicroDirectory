                    ...
                    <tr class="flexTbl">
                        ...
                        <td><span class="mobileShow">Country :</span> {{ $item->country_name }}</td>
                          ...
                          @if ($item && $item->is_active)
                           <a href="{{route('country.status',$item->id)}}" onclick="return confirm('Are you sure?')"><span class="badge bg-success">Active</span></a>
                        @else
                           <a href="{{route('country.status',$item->id)}}" onclick="return confirm('Are you sure?')"><span class="badge bg-danger">Inactive</span></a>
                        @endif
                        </td>
                        <td>
                            <div class="ThreeBtns">
