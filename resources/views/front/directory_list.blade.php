...
<html class="no-js" lang="en" >
	<!--<![endif]-->
	<head>
    	       	      <meta name="pagetitle" content="Indian Film Industry Directory :: Online Film Directory Of Actors, Actresses" />

    		    	      <meta name="keywords" content="Actors, Bollywood,Malayalam Actors, Tamil Actors, Telugu Actors, Kannada Actors, Bengali Actors,Marathi Actors, Punjabi Actors, BHojpuri Actors" />

    	        	    	 <meta name="description" content="Directory of the male actors, female actors from  Bollywood, Malayalam Actors, Tamil Actors, Telugu Actors, Kannada Actors, Bengali Actors, Marathi Actors, Punjabi Actors, Bhojpuri Actors" />
...
<script>
    $(document).ready(function () {
		...
		pageurl = "{{asset('front')}}/directory_list/actor";
	...
	function GetAjaxfilterList()
	{
			...
			$('#loader').show();
			parpage = "{{asset('front')}}/directory_list/actor";
			$.ajax({
				type: "POST",
				url:parpage,
				data: {search_location:search_location,search_subcategory:search_subcategory,search_speciality:search_speciality,search_services:search_services,search_products:search_products,search_country:search_country,search_state:search_state,search_ages:search_ages,search_directoryname:search_directoryname},
	...
	function bindstate()
	{
		...
		if(search_country != '')
		{
			...
			$.ajax({
					type: "POST",
					url:"{{asset('front')}}/ajaxbindstatelist",
	...
	function bindcity()
	{
		...
		if(search_state != '')
		{
			...
			$.ajax({
					type: "POST",
					url:"{{asset('front')}}/ajaxbindcitylist",
							...
							<h4>Featured Listings<!--Featured Directory--></h4>
										...
										<div class="row f_360">
											<div class="col-xs-3 col-sm-3 col-md-5 block-1">
												<a href="{{asset('front')}}/freshers/nikhar-pradhan">
																											<img src="{{asset('front')}}/directorylist/resizeimage/1703228673.jpg" alt="" class="img-responsive img-circle dib">
																									</a>
											</div>
											<div class="col-xs-9 col-sm-9 col-md-7 block-2 feture_name_box">
                                                ...
                                                <p>Mumbai</p>
                                                <div><a href="{{asset('front')}}/freshers/nikhar-pradhan">Click here to know more</a></div>
											</div>
										</div>
										...
										<div class="row f_360">
											<div class="col-xs-3 col-sm-3 col-md-5 block-1">
												<a href="{{asset('front')}}/actor/abhishek-arya">
																											<img src="{{asset('front')}}/directorylist/resizeimage/1699082502.jpg" alt="" class="img-responsive img-circle dib">
																									</a>
											</div>
											<div class="col-xs-9 col-sm-9 col-md-7 block-2 feture_name_box">
                                                ...
                                                <p>Mumbai</p>
                                                <div><a href="{{asset('front')}}/actor/abhishek-arya">Click here to know more</a></div>
											</div>
										</div>
										...
										<div class="row f_360">
											<div class="col-xs-3 col-sm-3 col-md-5 block-1">
												<a href="{{asset('front')}}/actor/rishi-suresh">
																											<img src="{{asset('front')}}/directorylist/resizeimage/1699022302.jpeg" alt="" class="img-responsive img-circle dib">
																									</a>
											</div>
											<div class="col-xs-9 col-sm-9 col-md-7 block-2 feture_name_box">
                                                ...
                                                <p>Kochi</p>
                                                <div><a href="{{asset('front')}}/actor/rishi-suresh">Click here to know more</a></div>
											</div>
										</div>
										...
										<div class="row f_360">
											<div class="col-xs-3 col-sm-3 col-md-5 block-1">
												<a href="{{asset('front')}}/model/veera">
																											<img src="{{asset('front')}}/directorylist/resizeimage/1699078296.jpg" alt="" class="img-responsive img-circle dib">
																									</a>
											</div>
											<div class="col-xs-9 col-sm-9 col-md-7 block-2 feture_name_box">
                                                ...
                                                <p>Dubai South</p>
                                                <div><a href="{{asset('front')}}/model/veera">Click here to know more</a></div>
											</div>
										</div>
										...
										<div class="row f_360">
											<div class="col-xs-3 col-sm-3 col-md-5 block-1">
												<a href="{{asset('front')}}/actor/mounis-ratta">
																											<img src="{{asset('front')}}/directorylist/resizeimage/1699178374.jpg" alt="" class="img-responsive img-circle dib">
																									</a>
											</div>
											<div class="col-xs-9 col-sm-9 col-md-7 block-2 feture_name_box">
                                                ...
                                                <p>Mumbai</p>
                                                <div><a href="{{asset('front')}}/actor/mounis-ratta">Click here to know more</a></div>
											</div>
										</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 block-1" >
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3 col-md-3 block-1">
					...
					<ul>
					<li><a href="{{asset('front')}}" target="_blank">About us</a></li>
					<li><a href="{{asset('front')}}" target='_blank'>Terms & Conditions</a></li>
						<li><a href="{{asset('front')}}" target='_blank'>Privacy statement</a></li>
						<li><a href="{{asset('front')}}" target='_blank'>Registration Procedures</a></li>
						<li><a href="{{asset('front')}}" target='_blank'>Feedback</a></li>
					</ul>
				</div>
				<div class="col-xs-12 col-sm-3 col-md-3 block-1">
