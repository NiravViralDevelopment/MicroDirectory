<html class="no-js" lang="en" >
	<!--<![endif]-->
	<head>
    	       	      <meta name="pagetitle" content="Abhishek Arya: The Actor" />

    		    	      <meta name="keywords" content="Abhishek Arya, Poet, Actor, Theatre Artist, Director" />

    	        	    	 <meta name="description" content="Abhishek Arya is an actor, poet, writer and director with a masters in Theatre and has been doing theatre for the last 12 years. " />


		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width">
		<link rel="shortcut icon" href="https://atomdirectory.com/favicon.ico">

		  <title>ATOM Directory :: A Talent Organizing and Management Directory for New Actors and Models</title>

		<link href="https://atomdirectory.com/assets/css/select2.css" rel="stylesheet">

		<link href="https://atomdirectory.com/assets/css/bootstrap.min.css" rel="stylesheet">
		<link href="https://atomdirectory.com/assets/css/style.css" rel="stylesheet">
		<link rel="stylesheet" href="https://atomdirectory.com/assets/vendor/pnotify/pnotify.custom.css" />
		<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
		<!--[if lt IE 9]>
		<script src="js/html5shiv.js"></script>
		<script src="js/respond.min.js"></script>
		<![endif]-->
		<script src="https://atomdirectory.com/assets/js/custom.modernizr.js" type="text/javascript" ></script>
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
		<script src="https://atomdirectory.com/assets/js/jquery.validate.js"></script>
		<script>
				window.jQuery || document.write('<script src="https://atomdirectory.com/assets/js/jquery.js"><\/script>')
		</script>
		<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
		<script src="https://atomdirectory.com/assets/js/bootstrap.min.js"></script>
		<script type="text/javascript" src="https://atomdirectory.com/assets/ckeditor/ckeditor.js"></script>
	</head>

	<body>
		<div style="background:url(https://atomdirectory.com/assets/images/with_trn.png) repeat left top; position:fixed; width:100%; height:100%; left:0px; top:0px; z-index:999999;" id="loader">

		<div style="position:absolute; left:0px; top:0px; width:100%; height:100%; background:url(https://atomdirectory.com/assets/images/ajax-loader.gif) no-repeat center center;"></div>
		</div>
...
<div class="top-listing header_inner">
	<div class="container">
		<div class="row">
            ...
            <div class="listing-block topright inner_number">
                <div class="login_top">
                <ul>		<li><a href=""><span class="glyphicon glyphicon-phone"></span> &nbsp;Whatsapp : +971 522 65 6679</a></li><li><a href=""><span class="glyphicon glyphicon-phone"></span> Call Us : +971522656679</a></li>
	...
	<div class="clear"></div>
			...
			<div class="col-xs-12 col-sm-12 col-md-3">
				<div class="logo"><a href="https://atomdirectory.com/"><img src="https://atomdirectory.com/assets/img/atom-header-logo.png" alt="" class="img-responsive dib" /></a></div>
			</div>
...
</div>		<link rel="stylesheet" href="https://atomdirectory.com/assets/css/jquery.fancybox.css" media="all" />
<link href="https://atomdirectory.com/assets/css/set1.css" rel="stylesheet" />
<script src="https://atomdirectory.com/assets/js/jquery.fancybox.min.js"></script>
<div class="container">
	<div class="row">
        <div class="col-md-12">
			...
			<div class="details-banner">
									<img src="https://atomdirectory.com/userfiles/directorylist/orignalimage/1699082502.jpg" alt="" class="img-responsive dib" />

			</div>
			<div class="btnBlock">
														<a href="javascript:void(0);" data-toggle="modal" data-target="#myModal" class="whislistbtn" onclick="hideregisterdiv();">Add to List</a>
													<a href="https://atomdirectory.com/directorylist/actor"  class="backBtn"> Back to Listing Page </a> </div>
		</div>
				...
				<div class="company-header">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-7">
							<a href="">
								<div><h1 class="title">Abhishek Arya</h1><br>
								<!-- Maharashtra, -->
								Actor,
								 Mumbai</div>
							</a>
							...
							<div class="company-content paddleftrightnone paddbtn0">
								...
								<div class="row no-left-right-margin poi-and-body paddbtm_detail divflex">
                                    <ul class="list_btm_area">
										...
										<li>
											<a href="http://instagram.com/Kabhiabhishek" target="_blank"><span class="glyphicon glyphicon-user icon-circle border border-dark-blue with-text"></span>Facebook/Instagram</a></li>
								...
								<div class="tab-pane active" id="aboutus">
									<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-12 block-1">
											<p>Abhishek Arya has a masters in Theatre and has been doing theatre for the last 12 years. He has done a feature film as a protagonist and also doing a web series. He has done a few episodes in. Crime Patrol, and also some cameos in regional films. He is passionate about theeatre and keeps doing plays.He is a poet and a very good singer. He can speak sanskrit fluently.</p>

<p><strong>Vital stats&nbsp;</strong></p>

<ol>
	<li>Height :&nbsp; 175 Cms</li>
	<li>Weight : 60Kgs</li>
	<li>Shoes Size : EU 41/ UK-7</li>
	...
	<li>Eye Color : Black</li>
											...
											<div class="row">
												<div class="col-xs-12 col-sm-12 col-md-12 block-1">
															...
															<ul class="item-list">
															   																		<li><span class="glyph icon-tick with-text"></span>Another Product</li>
																  																		<li><span class="glyph icon-tick with-text"></span>Some Product</li>
																  															</ul>
															<br />

												   															<p class="bold">Languages Known</p>
															<ul class="item-list">
																																		<li><span class="glyph icon-tick with-text"></span>English</li>
																  																		<li><span class="glyph icon-tick with-text"></span>Haryanvi</li>
																  																		<li><span class="glyph icon-tick with-text"></span>Hindi</li>
																  															</ul>
															<br />
													  												</div>
											</div>
											...
											<div class="row">
												<div class="col-xs-12 col-sm-12 col-md-12 block-1">
															...
															<ul class="item-list">
															   																		<li><span class="glyph icon-tick with-text"></span>Feature Films</li>
																  																		<li><span class="glyph icon-tick with-text"></span>Short Films</li>
																  																		<li><span class="glyph icon-tick with-text"></span>Television Serials</li>
																  																		<li><span class="glyph icon-tick with-text"></span>Theatre</li>
																  																		<li><span class="glyph icon-tick with-text"></span>Web Series</li>
																  															</ul>
															<br />
													  												</div>
											</div>
												   ...
												   <div class="photo-gallery">
                                                       <div class="row">
                                                           ...
                                                           <div class="gallery-photo">
                                                               <table>
                                                               <tr>
                                                                   <td><figure class="gal-photo">  <a data-fancybox="gallery" href="https://atomdirectory.com/userfiles/gallery/photo/main/16990831666.jpg"><img src="https://atomdirectory.com/userfiles/gallery/photo/medium/16990831666.jpg" alt='' /></a></figure></td>
                                                                   </tr>
                                                               </table>
                                                           ...
                                                           <div class="gallery-photo">
                                                               <table>
                                                               <tr>
                                                                   <td><figure class="gal-photo">  <a data-fancybox="gallery" href="https://atomdirectory.com/userfiles/gallery/photo/main/16990831665.jpg"><img src="https://atomdirectory.com/userfiles/gallery/photo/medium/16990831665.jpg" alt='' /></a></figure></td>
                                                                   </tr>
                                                               </table>
                                                           ...
                                                           <div class="gallery-photo">
                                                               <table>
                                                               <tr>
                                                                   <td><figure class="gal-photo">  <a data-fancybox="gallery" href="https://atomdirectory.com/userfiles/gallery/photo/main/16990831664.jpg"><img src="https://atomdirectory.com/userfiles/gallery/photo/medium/16990831664.jpg" alt='' /></a></figure></td>
                                                                   </tr>
                                                               </table>
                                                           ...
                                                           <div class="gallery-photo">
                                                               <table>
                                                               <tr>
                                                                   <td><figure class="gal-photo">  <a data-fancybox="gallery" href="https://atomdirectory.com/userfiles/gallery/photo/main/16990831663.jpg"><img src="https://atomdirectory.com/userfiles/gallery/photo/medium/16990831663.jpg" alt='' /></a></figure></td>
                                                                   </tr>
                                                               </table>
                                                           ...
                                                           <div class="gallery-photo">
                                                               <table>
                                                               <tr>
                                                                   <td><figure class="gal-photo">  <a data-fancybox="gallery" href="https://atomdirectory.com/userfiles/gallery/photo/main/16990831662.jpg"><img src="https://atomdirectory.com/userfiles/gallery/photo/medium/16990831662.jpg" alt='' /></a></figure></td>
                                                                   </tr>
                                                               </table>
                                                           ...
                                                           <div class="gallery-photo">
                                                               <table>
                                                               <tr>
                                                                   <td><figure class="gal-photo">  <a data-fancybox="gallery" href="https://atomdirectory.com/userfiles/gallery/photo/main/16990831661.jpg"><img src="https://atomdirectory.com/userfiles/gallery/photo/medium/16990831661.jpg" alt='' /></a></figure></td>
                                                                   </tr>
                                                               </table>
												...
												<div class="col-xs-12 col-sm-12 col-md-12 block-1">
													<div class="video-gallery">
														<div class="row">
																	...
																	<div class="video-lst">
																	  <div class="video-row">
																		<iframe allowfullscreen="allowfullscreen" width="100%" height="290" frameborder="0" src="https://www.youtube.com/embed/QYCt4Hhe3Yc?si=zhYZSglwqlZNnzIi"></iframe>
																	  </div>
																	...
																	<div class="video-lst">
																	  <div class="video-row">
																		<iframe allowfullscreen="allowfullscreen" width="100%" height="290" frameborder="0" src="https://www.youtube.com/embed/ifA-12VXGcg?si=iUb5grvLCYXHR1Gs"></iframe>
																	  </div>
											...
											<div class="row">
												<div class="col-xs-12 col-sm-12 col-md-12 block-1">
													<ul class="caseList">
																														<li>
																	<div class="caseBlock">
																		Experience																		<div class="downloadBlock"><a target="_blank" href="https://atomdirectory.com/userfiles/directorylist/document/Tattva_Media_Sponsorship-v1.pdf" class="btn btnDownload hvr-rectangle-out"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Download Now</a></div>
																	</div>
																</li>
														  												</div>
											</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 fb-block blue">
								<a href="http://instagram.com/Kabhiabhishek" target="_blank"><p class="bold"><span class="glyph icon-facebook"></span> Find us on Facebook</p></a>
							</div>
						</div>
					</div>-->
			  		</div>
		<div class="col-xs-12 col-sm-12 col-md-3 detailsbig-logo">
			<div class="white-block">
				<img src="https://atomdirectory.com/assets/img/advert.jpg" alt="advertisement" class="img-responsive dib" />
			</div>
		</div>
						<div class="col-xs-12 col-sm-12 col-md-3">
									...
									<div class="row f_360">
										<div class="col-xs-3 col-sm-3 col-md-5 block-1">
											<a href="https://atomdirectory.com/directory_detail/actor/mounis-ratta">
																									<img src="https://atomdirectory.com/userfiles/directorylist/resizeimage/1699178374.jpg" alt="" class="img-responsive dib feature_img_box">
																							</a>
										</div>
									...
									<div class="row f_360">
										<div class="col-xs-3 col-sm-3 col-md-5 block-1">
											<a href="https://atomdirectory.com/directory_detail/actor/rishi-suresh">
																									<img src="https://atomdirectory.com/userfiles/directorylist/resizeimage/1699022302.jpeg" alt="" class="img-responsive dib feature_img_box">
																							</a>
										</div>
										<div class="col-xs-9 col-sm-9 col-md-7 block-2 feture_name_box">
		...
		<div class="col-xs-12 col-sm-12 col-md-12 block-1" >
			<div class="row">
				<div class="col-xs-12 col-sm-2 col-md-2 block-1">
					<h1><img src="https://atomdirectory.com/assets/img/atom-logo.png" alt="" class="img-responsive dib" /></h1>
				</div>
				<div class="col-xs-12 col-sm-3 col-md-3 block-1">

					<ul>
					<li><a href="https://atomdirectory.com/Aboutus" target="_blank">About us</a></li>
					<li><a href="https://atomdirectory.com/Termsandconditions" target='_blank'>Terms & Conditions</a></li>
						<li><a href="https://atomdirectory.com/Privacystatement" target='_blank'>Privacy statement</a></li>
						<li><a href="https://atomdirectory.com/Registrationprocedures" target='_blank'>Registration Procedures</a></li>
						<li><a href="https://atomdirectory.com/Feedback" target='_blank'>Feedback</a></li>
					</ul>
				</div>
				<div class="col-xs-12 col-sm-3 col-md-3 block-1">
...
<script>
	...
	function checkemail1()
	{
		...
		{
			type : "POST",
			url:"https://atomdirectory.com/Registration/checkemail",
			data : {'email': email},
			async:false,
	...
	function checkphone()
	{
		...
		{
			type : "POST",
			url:"https://atomdirectory.com/Registration/checkphone",
			data : {'phone': phone},
			async:false,
			success : function (data)
			{
	...
	function checkusername()
	{
		...
		if(username != "")
		{
			...
			{
				type : "POST",
				url:"https://atomdirectory.com/Signin/checkusername",
	...
	function submitSignInForm()
	{
		...
		if($("#login_form").valid())
		{
			...
			{
				type:"POST",
				url	:"https://atomdirectory.com/Signin/verify_login",
				data:form,
				success: function(data)
				{
					if(data == 2)
	...
	function submitSignUpForm()
	{
			...
			if($("#registrtion_form").valid())
		{
			...
			{
				type:"POST",
				url	:"https://atomdirectory.com/Registration/add",
				data:form,
				success: function(data)
				{
					//alert(data);
					if(data == 1)
					{
						...
						window.location.href = "https://atomdirectory.com/Thankyou";
					}
					else if(data == 2)
					{
						$('#loader').hide();
	...
	function submitForgotPasswordForm()
	{
		if($("#forgot_password_form").valid())
		{
			...
			{
				type:"POST",
				url	:"https://atomdirectory.com/Signin/forgot_password",
				data:form,
				success: function(data)
				{
					if(data == 1)
	...
	function add_wishlist(wishlist_user_id,user_id)
	{
		$('#loader').show();
			...
			{
				type:"POST",
				url	:"https://atomdirectory.com/Wishlist/add_wishlist",
...
$('#loader').hide();
	...
	function remove_wishlist(wishlist_user_id,user_id)
	{
		$('#loader').show();
			...
			{
				type:"POST",
				url	:"https://atomdirectory.com/Wishlist/remove_wishlist",
				data:{'user_id': user_id,'wishlist_user_id':wishlist_user_id},
				success: function(data)
				{
...
<div class="modal fade popup_modal" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		...
		<!--JavaScript
		================================================== -->
		<script src="https://atomdirectory.com/assets/js/select2/select2.js"></script>
		<script src="https://atomdirectory.com/assets/js/custom.js"></script>
		<script src="https://atomdirectory.com/assets/vendor/pnotify/pnotify.custom.js"></script>
