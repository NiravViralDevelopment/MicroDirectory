                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="facebook" placeholder="Enter Facebook" class="form-control required">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Website:</strong>
                                <input type="text" name="website" placeholder="Enter Website" class="form-control required">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Experience:</strong>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description" class="form-control required" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <strong class="strng required-label">Meta Description:</strong>
                                <textarea name="meta_description" class="form-control required" rows="3"></textarea>
                            </div>
                        </div>
